...
public class StatefulSmartContract2 {
    ...
    public Long createApp(AlgodClient client, Account creator, TEALProgram approvalProgramSource,
        ...
        Transaction txn = Transaction.ApplicationCreateTransactionBuilder().sender(sender).suggestedParams(params)
                .approvalProgram(approvalProgramSource).clearStateProgram(clearProgramSource)
    ...
    public void optInApp(AlgodClient client, Account account, Long appId) throws Exception {
        ...
        // create unsigned transaction
        Transaction txn = Transaction.ApplicationOptInTransactionBuilder().sender(sender).suggestedParams(params)
    ...
    public static void main(String args[]) throws Exception {
        StatefulSmartContract2 t = new StatefulSmartContract2();
