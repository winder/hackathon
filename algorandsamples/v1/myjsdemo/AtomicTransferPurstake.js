...
const gettingClient = new algosdk.Algod(token, baseServer, port);
...
// Create client for transaction POST purestake
const postToken = {
    'X-API-key': 'B3SU4KcVKi94Jap2VXkK83xx38bsv95K5UZm2lab',
...
// local
// const postToken = {
//     'X-API-key': 'ec068ed68dc176e61a07b897c53835c6fb956271ce70aad3b204f0db6fa34f6d',
//     'Content-Type': 'application/x-binary'
// };
const postingClient = new algosdk.Algod(postToken, baseServer, port);
...
(async () => {
    ...
    let params = await gettingClient.getTransactionParams();
    let endRound = params.lastRound + parseInt(1000);
    let fee = await gettingClient.suggestedFee();
    ...
    // send the group
    let tx = (await postingClient.sendRawTransactions(signed));
