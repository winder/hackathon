...
# $ ./ goal account new -d [datadirectory] -w [walletname]
# Visit the Algorand dispenser and enter the account address to fund your account.
# https://bank.testnet.algorand.network/

# Next, in params.py, either update the tokens and addresses.
...
# Purestake - uncomment the next two lines and comment the one above
# purestake_token = {'X-Api-key': params.algod_token}
# acl = algod.AlgodClient(params.algod_token, params.algod_address, headers=purestake_token)
...
transaction_id = acl.send_transaction(
    signed_with_kmd, headers={'content-type': 'application/x-binary'})
