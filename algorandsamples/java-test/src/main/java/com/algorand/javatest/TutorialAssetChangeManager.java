 ...
 */
public class TutorialAssetChangeManager {
    ...
    public ChangingBlockParms getChangingParms(AlgodApi algodApiInstance) throws Exception {
        ChangingBlockParms cp = new TutorialAssetChangeManager.ChangingBlockParms();
        try {
    ...
    public static void main(String args[]) throws Exception {
        ...
        TutorialAssetChangeManager ex = new TutorialAssetChangeManager();
