 ...
 */
public class TutorialAssetRevoke {
    ...
    public ChangingBlockParms getChangingParms(AlgodApi algodApiInstance) throws Exception {
        ChangingBlockParms cp = new TutorialAssetRevoke.ChangingBlockParms();
        try {
    ...
    public static void main(String args[]) throws Exception {
        ...
        TutorialAssetRevoke ex = new TutorialAssetRevoke();
        ...
        BigInteger assetID = BigInteger.valueOf(319432);
        // set asset xfer specific parameters
        BigInteger assetAmount = BigInteger.valueOf(10);
        Address sender = acct2.getAddress();
        Address receiver = acct1.getAddress();
        Address clawbackFrom = acct3.getAddress();       

        Transaction tx = Transaction.AssetClawbackTransactionBuilder().sender(sender)
                .assetClawbackFrom(clawbackFrom).assetReceiver(receiver).assetAmount(assetAmount)
        ...
        try{
            ...
            System.out.println("Account 3 holding: " + act.getHolding(assetID).getAmount() );
        } catch (Exception e){
            e.printStackTrace();
            return;
        }  
