 ...
 */
public class TutorialAssetDestroy {
    ...
    public ChangingBlockParms getChangingParms(AlgodApi algodApiInstance) throws Exception {
        ChangingBlockParms cp = new TutorialAssetDestroy.ChangingBlockParms();
        try {
    ...
    public static void main(String args[]) throws Exception {
        ...
        TutorialAssetDestroy ex = new TutorialAssetDestroy();
        ...
        // set asset destroy specific parameters
        Address manager = acct1.getAddress();
        // The manager must sign and submit the transaction
        Transaction tx = Transaction.AssetDestroyTransactionBuilder().sender(manager).flatFee(1000).assetIndex(assetID)
        ...
        try{
            ...
            System.out.println( "Does AssetID: " + assetID + " on Account 1 exist? " + 
