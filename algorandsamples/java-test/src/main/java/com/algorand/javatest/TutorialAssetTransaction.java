 ...
 */
public class TutorialAssetTransaction {
    ...
    public ChangingBlockParms getChangingParms(AlgodApi algodApiInstance) throws Exception {
        ChangingBlockParms cp = new TutorialAssetTransaction.ChangingBlockParms();
        try {
    ...
    public static void main(String args[]) throws Exception {
        ...
        TutorialAssetTransaction ex = new TutorialAssetTransaction();
