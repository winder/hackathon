...
public class SearchTxAddressTime {
    ...
    public static void main(String args[]) throws Exception {
        ...
        String response = indexerClientInstance.searchForTransactions().address(account).afterTime(start_time).execute().toString();
        JSONObject jsonObj = new JSONObject(response.toString());
        System.out.println("start_time: 06/03/2020 11:00:00 = " + jsonObj.toString(2)); // pretty print json
    }
 }